# BoxifyPack · 23 款产品图样机对照表

> **策略：** 优先用免费 PSD 样机（mockups-design.com 为主，缺口去其他站补）。  
> **盒面设计：** 大面积留白 + 淡墨绿 `#1d5a4e` 色块即可，**不要 logo、不要假品牌名**。  
> **导出：** JPG · 约 **1200×800** · 背景统一浅灰 `#f5f5f5` 或纯白。  
> **工具：** Photoshop 或免费 [Photopea](https://www.photopea.com)（打开 PSD → 双击 Smart Object → 粘贴设计 → 导出 JPG）。

图例：**✅ 有样机** · **⚠️ 近似样机**（结构接近，客户能认） · **❌ 无合适样机**（看对标参考，自行处理）
...
### P1 · 儿童安全插舌盒 · Child-Resistant Tuck-End Carton
...
### P2 · 保健品套筒盒 · Supplement Sleeve Carton
...
### P3 · 维生素胶囊瓶外盒 · Vitamin & Capsule Bottle Carton
...
### F4 · 糖果折叠盒 · Candy & Confectionery Carton
...
### F5 · 巧克力折叠盒 · Chocolate Folding Carton
...
### B2 · 面霜开窗盒 · Cream Box with Window
...
### B5 · 护肤通用盒 · Skincare & Cosmetic Carton
...
### G1 · 磁吸翻盖礼盒 · Magnetic Closure Box
...
### G6 · 香水礼盒 · Perfume & Fragrance Gift Box
...
| 网站 | 特点 | 授权 |
|------|------|------|
| [mockups-design.com](https://mockups-design.com) | 5400+ 包装样机，风格统一，**首选** | 免费商用，无需署名 |
| [pacagemockup.com](https://www.pacagemockup.com) | 食品/药/美妆类全 | 多数免费商用 |
| [mockupworld.co](https://www.mockupworld.co) | 聚合高质量 PSD | 各文件见下载页 |
| [free-mockup.com](https://www.free-mockup.com) | 礼盒/ rigid box 多 | 免费商用 |
| [pixpine.com](https://pixpine.com) | 磁吸盒、巧克力等 | 免费资源可商用 |
| [unblast.com](https://unblast.com) | 美妆、食品 | CC / 见下载页 |
| [goodmockups.com](https://goodmockups.com) | Anthony Boyd 高窄盒 | 免费商用 |
| [mockup3dfree.com](https://mockup3dfree.com) | 插舌折叠盒 | 免费 |
| [pacdora.com](https://www.pacdora.com/tools/carton-box-mockup) | **浏览器 3D**，无需 PS，可下 PNG | 免费档可用 |

**注意：** Designbolts 等部分站点要求 linkback（放博客可忽略；商用官网一般 OK，以各站 license 为准）。

---

## 七、Photopea 快速流程（无 Photoshop）

1. 打开 [photopea.com](https://www.photopea.com) → File → Open → 选下载的 PSD  
2. 图层面板找到 **Smart Object**（带小图标）→ 双击缩略图  
3. 粘贴你的留白盒面设计 → Ctrl+S 保存 → 关闭 Smart Object 窗口  
4. 可选：改 Background 层为 `#f5f5f5`  
5. File → Export As → JPG，宽 **1200px**  
6. 按上表「导出文件名」保存，替换 `images/products/web/` 或 `images/products/food/`
...
| 目录 | 产品 |
|------|------|
| `images/products/web/` | P1–P5, B1–B6, G1–G4, G6 |
| `images/products/food/` | F1–F6, G5（Wine） |

出图完成后把 JPG 发回来或自行覆盖，可在仓库里跑测试确认 lazy-load 正常。

---

*文件：MOCKUPS-MAPPING.md · 对应 boxifypack.com 23 款目录 · 样机方案替代即梦 AI 出图*
